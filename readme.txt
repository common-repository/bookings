...
Tags: digital appointment, digital booking, booking, schedule, scheduler, appointment, reservation, appointment, availability, availability calendar, booking calendar, booking form, calendar, event calendar, events, reservation plugin, scheduling, online reservation, appointment scheduling
Requires at least: 4.6
Tested up to: 4.7.2
Stable tag: 6.0.4

Simply the best online reservations & appointment scheduling solution for Wordpress.

== Description ==

Bookings is a powerful digital appointment booking solution that allows you to provide online booking services on your website.

Whether you're running a beauty salon, medical practice, gym, consultancy, providing hotel rooms or running a school, visitors to your site will be able to check availability of your services and products and make online bookings.
...
* Community support via our [Forums](https://wordpress.org/support/plugin/bookings "Forums") 
...
* Priority support via our [Helpdesk](https://zingiri.com/go/submitticket.php "Helpdesk") and by phone

Note: Bookings uses web services stored on Zingiri's servers, read more in the plugin's FAQ about what that means.

== Installation ==

1. Look for `bookings` in the plugin installation panel.
2. Click on 'Install Now' to install the plugin.
3. Activate the plugin.
4. Include the code [bookings] in any page to display the bookings form. There are differrent options for formatting the bookings form that are explained in our [documentation](http://www.zingiri.com/go/dl.php?type=d&id=29 "documentation").

Please visit [Zingiri](http://www.zingiri.com "Zingiri") for more information and support.
...
= 6.0.4 =
* Fixed issue with call to bookings_load_js_client()

= 6.0.3 =
* Fixed issue with hidden buttons on reservation dialog in back-end
* Updated font-size on various pages in back-end to the default size
* Fixed issue where sub-elements in forms are not appearing on the same line but instead one beneath the other
* Added latest reservations to dashboard

= 6.0.2 =
* Fixed issue with a link to the bookings portal
* Rearranged some of the settings to make it more user friendly
* More look-and-feel refactoring
* Added new welcome dashboard

= 6.0.1 =
* Added possibility to sign up for free Bookings Pro trial
